	...
	return (
		<>
			...
			<div className="flex flex-col md:flex-row  py-8 px-4">
				<div className="md:w-1/2 bg-white rounded-lg shadow-lg p-8 blue-glassmorphism">
					<div className="flex justify-center">
						<h3 className="text-xl font-semibold  text-[#0a61a4] mb-4">
							Research Projects
						</h3>
					</div>
					<div className="flex justify-center">
				...
				<div className="md:w-1/2 bg-white rounded-lg shadow-lg p-8 mt-4 md:mt-0 md:ml-4 blue-glassmorphism">
					<div className="flex justify-center">
						<h3 className="text-xl font-semibold  text-[#0a61a4] mb-4">
